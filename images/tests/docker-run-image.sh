...
#docker run -eDATABASE_PORT=3306 -eDATABASE_USER=root -eDATABASE_PASSWORD=root -eDATABASE_NAME=lozzikitUsers -eDATABASE_HOST=database --network=microserviceusersandteams_default  lozzikit/users-and-teams/tests