Feature: Update of users
  ...
  Background:
    ...
    Scenario: I Update firstname of a user and and everything is good
      Given I have a valid Authorization token
      And I update firstname
      When I PUT users from the /users endpoint
      Then I receive a 200 status code
    ...
    Scenario: I Update lastname of a user and and everything is good
      Given I have a valid Authorization token
      And I update lastname
      When I PUT users from the /users endpoint
      Then I receive a 200 status code
    ...
    Scenario: I Update email of a user and and everything is good
      Given I have a valid Authorization token
      And I update email
      When I PUT users from the /users endpoint
      Then I receive a 200 status code
    ...
    Scenario: I Update password of a user and it's not allowed
      Given I have a valid Authorization token
